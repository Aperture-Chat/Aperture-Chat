...
The current published release is [v0.5.3](https://github.com/Aperture-Chat/Aperture-Chat/releases/tag/v0.5.3).
...
```bash
python3 scripts/install-release.py --directory ./deployment --domain chat.example.com --tag v0.5.3 --start
```
...
| Tag | Use |
| --- | --- |
| `v0.5.3` | Reviewed stable release. Prefer a specific version for deployment. |
| `latest` | Moving stable-release alias. |
| `dev`, `test`, `main` | Moving image pairs for the corresponding release branch. |
| `v0.5.3-dev`, `v0.5.3-test`, `v0.5.3-main` | Moving branch aliases for commits carrying that version. |
