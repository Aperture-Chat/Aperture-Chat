...
The current published release is [v0.5.2](https://github.com/Aperture-Chat/Aperture-Chat/releases/tag/v0.5.2).
...
```bash
python3 scripts/install-release.py --directory ./deployment --domain chat.example.com --tag v0.5.2 --start
```
...
| Tag | Use |
| --- | --- |
| `v0.5.2` | Reviewed stable release. Prefer a specific version for deployment. |
| `latest` | Moving stable-release alias. |
| `dev`, `test`, `main` | Moving image pairs for the corresponding release branch. |
| `v0.5.2-dev`, `v0.5.2-test`, `v0.5.2-main` | Moving branch aliases for commits carrying that version. |
