...
const FOCUS_REGIONS: Record<UserFocus, FocusRegion> = {
  ...
  traceCollapsed: { frame: "training/user/chat-trace-expanded.png", rect: { x: 320, y: 255, w: 616, h: 38 } },
  traceExpanded: { frame: "training/user/chat-trace-expanded.png", rect: { x: 316, y: 253, w: 628, h: 266 } },
  ...
  agentMenu: { frame: "training/user/composer-agent.png", rect: { x: 259, y: 549, w: 570, h: 129 } },
  ...
  sendKnowledge: { frame: "training/user/composer-send-options.png", rect: { x: 559, y: 536, w: 250, h: 44 } },
  sendWeb: { frame: "training/user/composer-send-options.png", rect: { x: 559, y: 586, w: 250, h: 44 } },
  sendAgent: { frame: "training/user/composer-send-options.png", rect: { x: 559, y: 636, w: 250, h: 44 } },
  sendReasoning: { frame: "training/user/composer-send-options.png", rect: { x: 559, y: 698, w: 250, h: 34 } },
  sessionSummary: { frame: "training/user/chat-session-panel.png", rect: { x: 879, y: 70, w: 291, h: 315 } },
  contextWindow: { frame: "training/user/chat-session-panel.png", rect: { x: 881, y: 398, w: 288, h: 237 } },
  imageReply: { frame: "training/user/chat-images.png", rect: { x: 315, y: 339, w: 514, h: 344 } },
  imageDownload: { frame: "training/user/chat-images-download.png", rect: { x: 717, y: 612, w: 103, h: 33 } },
  mermaidFigure: { frame: "training/user/chat-mermaid.png", rect: { x: 315, y: 243, w: 516, h: 438 } },
  ...
  deckBrandStage: { frame: "training/user/deck-editor-brand.png", rect: { x: 656, y: 348, w: 499, h: 281 } },
  ...
  knowledgeAdd: { frame: "training/user/knowledge.png", rect: { x: 929, y: 90, w: 171, h: 43 } },
  knowledgeTable: { frame: "training/user/knowledge.png", rect: { x: 255, y: 156, w: 900, h: 89 } },
  ...
  automationsTabs: { frame: "training/user/automations.png", rect: { x: 778, y: 19, w: 211, h: 41 } },
  automationsNew: { frame: "training/user/automations.png", rect: { x: 1000, y: 19, w: 163, h: 44 } },
  automationsBanner: { frame: "training/user/automations.png", rect: { x: 248, y: 93, w: 916, h: 59 } },
  automationsCard: { frame: "training/user/automations.png", rect: { x: 247, y: 161, w: 916, h: 136 } },
  ...
  sidebarPreview: { frame: "training/user/sidebar-chat-preview.png", rect: { x: 310, y: 301, w: 436, h: 547 } },
