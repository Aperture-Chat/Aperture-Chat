...
export const OWNER_FOCUS_REGIONS: Record<OwnerFocus, FocusRegion> = {
  searchIndex: { frame: "training/owner/search-index.png", rect: { x: 264.906, y: 249.75, w: 881.188, h: 215 } },
  modelBrowsingPolicy: { frame: "training/owner/model-browsing-policy.png", rect: { x: 285.906, y: 405.75, w: 839.188, h: 44 } },
  addProvider: { frame: "training/owner/providers.png", rect: { x: 940, y: 279, w: 141, h: 45 } },
  providerCard: { frame: "training/owner/providers.png", rect: { x: 282, y: 382, w: 420, h: 256 } },
  providerStats: { frame: "training/owner/provider-catalog.png", rect: { x: 379.906, y: 701.75, w: 300.594, h: 78 } },
  providerCardActions: { frame: "training/owner/providers.png", rect: { x: 376, y: 529, w: 308, h: 91 } },
  ...
  vaultPanel: { frame: "training/owner/vault.png", rect: { x: 300, y: 626, w: 811, h: 165 } },
  vaultKeyRow: { frame: "training/owner/vault.png", rect: { x: 300, y: 732, w: 800, h: 59 } },
  vaultKeyActions: { frame: "training/owner/vault.png", rect: { x: 989, y: 732, w: 111, h: 49 } },
  modelsSearch: { frame: "training/owner/models.png", rect: { x: 601, y: 269, w: 482, h: 45 } },
  ...
  rolesUserRows: { frame: "training/owner/roles.png", rect: { x: 282, y: 262, w: 847, h: 593 } },
  ...
  brandActions: { frame: "training/owner/branding-actions.png", rect: { x: 285.906, y: 358.75, w: 839.188, h: 88 } },
  ...
  policyCollapsed: { frame: "training/owner/policies-current-collapsed.png", rect: { x: 261, y: 418, w: 889, h: 98 } },
  ...
  budgetControls: { frame: "training/owner/policies-budget-current.png", rect: { x: 283, y: 391, w: 845, h: 94 } },
  ...
  sharedConnectors: { frame: "training/owner/policies-callout-current.png", rect: { x: 262, y: 84, w: 887, h: 91 } },
  ...
  retentionSensitive: { frame: "training/owner/retention-sensitive.png", rect: { x: 277.906, y: 410.938, w: 855.188, h: 34 } },
  retentionHolds: { frame: "training/owner/retention-holds.png", rect: { x: 296.906, y: 318.703, w: 817.188, h: 216.875 } },
  retentionSchedulePreview: { frame: "training/owner/retention-schedule-preview.png", rect: { x: 277.906, y: 367.25, w: 855.188, h: 178.875 } },
  retentionPanel: { frame: "training/owner/retention-policy.png", rect: { x: 277.906, y: 401.188, w: 857.188, h: 157 } },
  ...
  retentionPreview: { frame: "training/owner/retention-preview.png", rect: { x: 174.5, y: 228.094, w: 836, h: 398.797 } },
  retentionBatch: { frame: "training/owner/retention-batch.png", rect: { x: 277.906, y: 355.016, w: 855.188, h: 145 } },
  firstOwnerSetup: { frame: "training/owner/first-owner-setup.png", rect: { x: 104.25, y: 362.172, w: 398, h: 442.172 } },
  firstOwnerWelcome: { frame: "training/owner/first-owner-welcome.png", rect: { x: 261.547, y: 24, w: 887.906, h: 271.172 } },
  firstProviderValidated: { frame: "training/owner/first-provider-validated.png", rect: { x: 713, y: 560, w: 413, h: 295 } },
  firstWorkspaceAccess: { frame: "training/owner/first-workspace-access.png", rect: { x: 282, y: 262, w: 847, h: 593 } },
  firstWorkspaceReply: { frame: "training/owner/first-workspace-reply.png", rect: { x: 318, y: 335.766, w: 833, h: 155.5 } },
};
...
export const OWNER_TRAINING_VIDEOS: OwnerTrainingVideo[] = [
  ...
  },
  {
    ...
    setupSteps: [
      "Choose Platform console near the bottom of the sidebar. Open Providers for connection settings or Documentation for step-by-step advice.",
  ...
  },
  {
    ...
    setupSteps: [
      "Choose Platform console near the bottom of the sidebar.",
